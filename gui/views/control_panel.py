...
class ControlPanel(QScrollArea):
    ...
    # === SINYAL BARU untuk menampilkan pesan ===
    ...
    # --- Fungsi Logika dan Slot ---
    def emergency_stop(self):
        """Mengirim perintah berhenti darurat dan memancarkan sinyal pesan."""
        ...
        # === PERBAIKAN: Gunakan sinyal untuk menampilkan pesan ===
